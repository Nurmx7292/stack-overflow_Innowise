...
import { useUserStatistic, useUpdateUser, useUpdatePassword, useDeleteUser } from '../../hooks/useUserApi'
...
export default function Account() {
  ...
  const { data: userStatistic, isLoading: isStatisticLoading, error: statisticError } = useUserStatistic(
    authUser?.id || 0
  )
  ...
  const handleDeleteAccount = async () => {
    ...
    const doubleConfirm = confirm('This will permanently delete your account and all your data. Type "DELETE" to confirm.')
